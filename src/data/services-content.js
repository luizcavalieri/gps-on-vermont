const services = [
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            descriptions: [
              "Talk to your GP and let them know where you are going and ask for preventative advice that suits your needs. Travelling could put your health at risk, especially if you need specific care that may be hard to find overseas. It’s better to know all your options so you don’t risk your health."
            ]
          },
          {
            icon: "",
          ...
          },
          {
            ...
            descriptions: [
              "Remember you are making decisions for two, so it is best to not only make an appointment with your GP but also see your obstetrician, talk to your travel insurer and airline. They will all advice you on what steps to take to reduce the risks to you and your baby."
            ]
          },
          {
            icon: "",
            ...
            descriptions: [
              "Talk to your GP about your destination and they will inform you of what vaccinations are required. Some do require a certificate, such as the Yellow Fever vaccination."
            ]
          }
        ]
      }
  ...
  },
  {
    ...
    items: [
      ...
      "Lung Function testings(Spirometry)",
      "Family planning",
      "Care of aged or disabled",
      "Heart checks",
      "Skin checks",
      "Liquid Nitrogen freezing for sunspots/warts",
      "Minor surgery",
      "Ear syringing",
      "Weight loss",
      "Workcover (VIC and NSW) Comcare, TAC (motor vehicle)",
        ...
        topics: [
          ...
          },
          {
            ...
            descriptions: [
              ...
              "4 years Old Healthy Kids checks",
              "Childhood illnesses"
            ]
          },
          {
          ...
          },
          {
            ...
            descriptions: [
              ...
              "Patient education",
              "Preparation of care plans and team care arrangements"
            ]
          },
          {
            icon: "",
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            descriptions: [
              "Yes, we highly recommend filling out the registration form before to save you some time! Link to hotdoc new patient registration form."
            ]
          },
          {
            icon: "",
  ...
  },
  {
    ...
    sections: [
      {
        title: "Pre-Employement medicals",
        topics: [
          {
            icon: "",
            type: "PARAGRAPH",
        ...
        topics: [
          {
            ...
            descriptions: [
              ...
              "Planning treatments and actions that will meet the goals, and planning review steps."
            ]
          },
          {
            icon: "",
